<p align="center">
<a href="https://github.com/ZThon-Ar/Zilzal-MD">
    <img src="https://i.imgur.com/MClOeqe.jpeg">
  </a>

<h1 align="center"> Zilzal MD
</h1>

<p align="center"> 
Konnichiwa Senpai, I am "Zilzal" an Opensource WhatsApp bot made by <a href="https://github.com/ZThon-Ar">FantoX</a> and his team "Zilzal" to do everything that's beyond imagination with highest <b>Features</b> and <b>Stability</b> and <b>Compatibility</b> built with Baileys Multi Device support.

<h3 align="center"> Zilzal MD - The Future Is Here
</h4>

<br>

<p align="center">
  <a href="https://github.com/ZThon-Ar/Zilzal-MD/fork">
    <img src="https://img.shields.io/github/forks/ZThon-Ar/Zilzal-MD?label=Fork&style=social">
    
    
  <a href="https://github.com/ZThon-Ar/Zilzal-MD/stargazers">
    <img src="https://img.shields.io/github/stars/ZThon-Ar/Zilzal-MD?style=social">
  </a>

<br>

<a href="https://github.com/ZThon-Ar/Zilzal-MD">
    <img src="https://visitor-badge.glitch.me/badge?page_id=https://github.com/ZThon-Ar/Zilzal-MD.visitor-badge&left_text=Total%20People%20Visited">
  </a>
  <br><br>
  
<p align="center">
<a href="https://github.com/ZThon-Ar"><img title="Owner" src="https://img.shields.io/badge/Owner-Team Zilzal-white.svg?style=for-the-badge&logo=github" width="170px"></a>

 <a href="https://github.com/ZThon-Ar/Zilzal-MD/blob/main/LICENSE.md">
  
<img src='https://img.shields.io/github/license/ZThon-Ar/Zilzal-MD?color=%231e81b0&style=for-the-badge' width="114px">

<p align="center">
<a href="https://github.com/ZThon-Ar"><img title="Open Source" src="https://img.shields.io/badge/Open%20Source-YES-green.svg?style=for-the-badge" width="150px"></a>
<a href="https://github.com/ZThon-Ar"><img title="" src="https://img.shields.io/badge/Maintained-YES-green.svg?style=for-the-badge" width="143px"></a>
</p>
<br>
...
<p align="center" >
    <a href="https://repl.it/github/ZThon-Ar/Zilzal-MD">
...
<p align="center" >
    <a href="https://heroku.com/deploy?template=https://github.com/ZThon-Ar/Zilzal-MD">
...
# 📑 Zilzal Deploy and Hosting guide
...
- [Fork Main Repo](https://github.com/ZThon-Ar/Zilzal-MD/fork)
...
- Click on `Deploy to Repl.it` button ( `For those who didn't modified bot.`). In other case (`For those who modified bot.`) edit README.md file and chage the repo link of Repl.it deply button from `https://github.com/Fantox01/Zilzal-MD` to your fork URL `https://github.com/<Your GitHub Username>/<Your Zilzal fork repo name>`.
...
- [Fork Main Repo](https://github.com/ZThon-Ar/Zilzal-MD/fork)
- Create a MongoDB URL. Need help? Watch this short 1 minute [Video Guide](https://youtube.com/shorts/pIHvoXkwmq4?feature=share) for MongoDB URL.
- Click on `Deploy to Heroku` button ( `For those who didn't modified bot.`). In other case (`For those who modified bot.`) edit README.md file and chage the repo link of Repl.it deply button from `https://github.com/Fantox01/Zilzal-MD` to your fork URL `https://github.com/<Your GitHub Username>/<Your Zilzal fork repo name>` also got to `app.json` and change `Website` ans `Repository` link from my link to your link. Then click on `Deploy to Heroku` button.
...
KEY | VALUE
-- | --
MODS | Phone numbers in this format (`967736847068`,`967772351752`) without `+` or `SPACE`.
MONGODB | Your MongoDB URL
SESSION_ID | Any random value (`EX: gwfdrte5678`) and `keep it copied`.
PREFIX | Any single special character except `@` (`Ex: . or / or * or , etc.`)
TENOR_API_KEY | Your tenor API key if you have. Or use this public one: `AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c`
...
- [Download Updated code](https://github.com/ZThon-Ar/Zilzal-MD/archive/refs/heads/main.zip) from Main GitHub Repo or Download from your Forked Repo.
...
git clone https://github.com/ZThon-Ar/Zilzal-MD
...
``` 
- Note in `git clone <my bot's repo>` section your can use Your customised bot's github link too (For that make sure you [Forked](https://github.com/ZThon-Ar/Zilzal-MD/fork) this repo and modified `.env` file and `config.js`).
- This method will work on most other bots too.

#### 📌 To stop a bot in Userland
- Tap on `CTRL` button then tap on `C` from keyboard

#### 📌 To start bot again ( While you are inside Zilzal-MD folder {use `cd Zilzal-MD` to get inside the folder} )
...
# ⚡️ Zilzal Platform Compatibility:
<br>

- Zilzal offers highest platform compatibility.
- Just deploy and use on your favourite platform.
- Sorted by Recommendation: Repl.it, Railway, Heroku, Koyeb
      
<br>
      
# 💫 Dependencies of Zilzal:

<br>

- [Baileys Library](https://github.com/adiwajshing/Baileys)
- [Scrappy API (For Instagram, Lyrics and ❌videos scraping )](https://github.com/ZThon-Ar/Scrappy-API)
...
- Read [PublicKeys.md](https://github.com/ZThon-Ar/Zilzal-MD/blob/main/PublicKeys.md) to use our `provided public keys` if you are lazy to create your own. We have already provided everying you need to run the bot.
- Changeable between `20 added Characters` ( Zilzal, Power, Makima, Denji, Zero Two, Chika, Miku, Marin Kitagawa ) and more can be added by user inside `BotCharacters.js` file. Type `-charlist` command to get character list.
...
# 〽️ Why Should You Use Zilzal as your Base:
...
- Zilzal is a `fully open source` bot which means `no copyright`.
- Zilzal is a `multi character bot` which means you can `change bot's character` to any of the 8 added characters or add more characters by yourself.
- Zilzal is a `multi database bot` which means you can use 3 different databases at the same time.
- Zilzal is a `multi mode` bot which means you can use it in `Self / Public / Private` mode.
- Zilzal has a pre installed chatbot which means you can use it as a `group chatbot and dm chatbot`.
- Zilzal has 300+ commands.
- Zilzal doesn't store your `Session File` locally which means it's `safe` and `secure`.
- Zilzal has `User Banning / Group Banning` which means you can use it as a `Anti Spam Bot`.
- Zilzal is a Folder Type bot which represents `Highest Stability`, `Highest Performance` and `Developer / User friendly`.
- Zilzal comes with [MIT](https://github.com/ZThon-Ar/Zilzal-MD/blob/main/LICENSE.md) License which means you can use it as a `base for your own bot` and can `modify it as you want` and can `add your own features`.
...
- Check [Zilzal Contributors](https://github.com/ZThon-Ar/Zilzal-MD/graphs/contributors) list.
...
<h2 align="center">🔰 Meet Team Zilzal 🔰
</h2>

[![Fantox](https://github.com/ZThon-Ar.png)](https://github.com/ZThon-Ar)  | [![Ahmii-kun](https://github.com/Ahmii-kun.png)](https://github.com/Ahmii-kun) | [![Pratyush](https://github.com/pratyush4932.png)](https://github.com/pratyush4932) | [![Devime](https://github.com/Devime69.png)](https://github.com/Devime69) | [![Kai](https://github.com/Kai0071.png)](https://github.com/Kai0071) | [![JayJay Ops](https://github.com/jayjay-ops.png)](https://github.com/jayjay-ops)
----|----|----|----|----|----
[FantoX](https://github.com/ZThon-Ar)  | [Ahmii Kun](https://github.com/Ahmii-kun) | [Pratyush](https://github.com/pratyush4932) | [Devime](https://github.com/Devime69) | [Kai](https://github.com/Kai0071) | [Jayjay Ops](https://github.com/jayjay-ops)
